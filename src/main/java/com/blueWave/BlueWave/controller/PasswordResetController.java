...
public class PasswordResetController {
    ...
    public ResponseEntity<?> solicitarRecuperacao(@RequestParam String email, HttpServletRequest request) {
        try {
            ...
            Voluntario voluntario = voluntarioRepository.findVoluntarioByEmail(email);
    ...
    public ResponseEntity<?> redefinirSenha(
        ...
        try {
            ...
            if ("voluntario".equals(resetToken.getUserType())) {
                Voluntario voluntario = voluntarioRepository.findVoluntarioByEmail(resetToken.getEmail());
                if (voluntario != null) {
                ...
                Ong ong = ongRepository.findOngByEmail(resetToken.getEmail());
                if (ong != null) {
