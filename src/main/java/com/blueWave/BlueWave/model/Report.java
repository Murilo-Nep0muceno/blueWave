...
public class Report {
    ...
    public void resolverPorAdmin(String resposta, String nomeAdmin) {
        this.status = StatusReport.RESOLVIDO;
        this.respostaAdmin = resposta;
        this.dataResposta = LocalDateTime.now();
        // Se você tiver um campo para armazenar o nome do admin responsável
        // this.adminResponsavelNome = nomeAdmin;
    }

    /**
     * Marca como rejeitado por admin
     */
    public void rejeitarPorAdmin(String motivo, String nomeAdmin) {
