...
public class Admin {
    ...
    // Campo transiente para último login formatado
    @Transient
    private String ultimoLoginFormatado;
    ...
    public String getUltimoLoginFormatado() {
        if (ultimoLoginFormatado != null) {
            return ultimoLoginFormatado;
        }
        if (ultimoLogin != null) {
    ...
    /**
     * Define o último login formatado
     */
    public void setUltimoLoginFormatado(String ultimoLoginFormatado) {
        this.ultimoLoginFormatado = ultimoLoginFormatado;
    }
